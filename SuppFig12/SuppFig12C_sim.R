...
# setwd("/path/to/csmGmm_reproduce/SuppFig12/SuppFig12C_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig12/SuppFig12C_sim.R")
...
outName <- paste0(outputDir, "/SFig12C_aID", Snum, "_aID", aID, ".txt")
...
testStatsName <- here::here(outputDir, "SFig12C_allZ")
betaName <- here::here(outputDir, "SFig12C_allBeta")
