...
# setwd("/path/to/csmGmm_reproduce/SuppFig12/SuppFig12A_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig12/SuppFig12A_sim.R")
...
outName <- paste0(outputDir, "/SFig12A_aID", Snum, "_aID", aID, ".txt")
...
testStatsName <- here::here(outputDir, "SFig12A_allZ")
betaName <- here::here(outputDir, "SFig12A_allZ")
