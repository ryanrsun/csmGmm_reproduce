...
# setwd("/path/to/csmGmm_reproduce/SuppFig29/SFig29E_sim_med.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig29/SFig29E_sim_med.R")
...
outName <- paste0(outputDir, "/SFig29E_aID", aID, "_fitmed.txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig29Efm_allZ")
betaName <- here::here(outputDir, "SFig29Efm_allBeta")
