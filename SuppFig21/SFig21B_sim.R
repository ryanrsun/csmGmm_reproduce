...
# setwd("/path/to/csmGmm_reproduce/SuppFig21/SFig21B_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig21/SFig21B_sim.R")
...
outName <- paste0(outputDir, "/SFig21B_aID", Snum, "_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig21B_allZ")
betaName <- here::here(outputDir, "SFig21B_allBeta")
