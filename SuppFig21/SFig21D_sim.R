...
# setwd("/path/to/csmGmm_reproduce/SuppFig21/SFig21D_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig21/SFig21D_sim.R")
...
outName <- paste0(outputDir, "/SFig21D_aID", aID, ".txt")

# option to save or load intermediate data to save time
loadData <- TRUE
saveData <- FALSE
testStatsName <- here::here(outputDir, "SFig21D_allZ")
betaName <- here::here(outputDir, "SFig21D_allZ")
