...
# setwd("/path/to/csmGmm_reproduce/SuppFig17/SuppFig17A_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig17/SuppFig17A_sim.R")
...
outName <- paste0(outputDir, "/Fig17A_aID", aID, ".txt")
...
betaOpts <- cbind(c(0.28 + 0.01 * effSizeMult, 0.38 + 0.01 * effSizeMult),
                  c(0.28 + 0.01 * effSizeMult, 0.38 + 0.01 * effSizeMult))
betaMin <- betaOpts[1, ]
betaMax <- betaOpts[2, ]
beta0 <- -1
