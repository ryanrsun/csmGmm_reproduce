...
# setwd("/path/to/csmGmm_reproduce/SuppFig26/SFig26A_sim_fit3.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig26/SFig26A_sim_fit3.R")
...
outName <- paste0(outputDir, "/SFig26A_aID", aID, "_fit3.txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig26Af3_allZ")
betaName <- here::here(outputDir, "SFig26Af3_allBeta")
