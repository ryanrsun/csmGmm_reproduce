...
# setwd("/path/to/csmGmm_reproduce/SuppFig26/SFig26A_sim_fit7.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig26/SFig26A_sim_fit7.R")
...
outName <- paste0(outputDir, "/SFig26A_aID", aID, "_fit7.txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig26Af7_allZ")
betaName <- here::here(outputDir, "SFig26Af7_allBeta")
