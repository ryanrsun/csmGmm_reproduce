...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig26/output"
outName <- paste0("SFig26A_aID", aID, "_fit7.txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- FALSE
testStatsName <- "SFig26A_allZ"
betaName <- "SFig26A_allBeta"
#-------------------------------------------------------------------#
