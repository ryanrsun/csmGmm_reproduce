...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig16/output"
outName <- paste0("SFig16C_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- TRUE
testStatsName <- "SFig16C_allZ"
betaName <- "SFig16C_allBeta"
#-------------------------------------------------------------------#
