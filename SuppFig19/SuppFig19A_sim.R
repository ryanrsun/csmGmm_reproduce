...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig19/output"
outName <- paste0("SFig19A_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- TRUE
testStatsName <- "SFig19A_allZ"
betaName <- "SFig19A_allBeta"
#-------------------------------------------------------------------#
