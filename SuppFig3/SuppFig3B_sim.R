...
# setwd("/path/to/csmGmm_reproduce/SuppFig3/SuppFig3B_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig3/SuppFig3B_sim.R")
...
outName <- paste0(outputDir, "/SuppFig3B_aID", aID, ".txt")
...
testStatsName <- here::here(outputDir, "SuppFig3B_allZ")
betaName <- here::here(outputDir, "SuppFig3B_allBeta")
