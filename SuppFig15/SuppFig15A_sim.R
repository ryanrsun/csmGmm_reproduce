...
# setwd("/path/to/csmGmm_reproduce/SuppFig15/SuppFig15A_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig15/SuppFig15A_sim.R")
...
outName <- paste0(outputDir, "/SFig15A_aID", aID, ".txt")
...
testStatsName <- here::here(outputDir, "SFig15A_allZ")
betaName <- here::here(outputDir, "SFig15A_allBeta")
