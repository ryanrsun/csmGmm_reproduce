...
# setwd("/path/to/csmGmm_reproduce/SuppFig15/SuppFig16B_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig15/SuppFig16B_sim.R")
...
outName <- paste0(outputDir, "/SFig16B_aID", Snum, "_aID", aID, ".txt")
