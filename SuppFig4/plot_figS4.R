...
names4aq3 <- paste0(outputDir, "Power_correctionS4A_S3_aID", 1:600, ".txt")
names4aq4 <- paste0(outputDir, "Power_correctionS4A_S4_aID", 1:600, ".txt")
names4aq5 <- paste0(outputDir, "Power_correctionS4A_S5_aID", 1:600, ".txt")
names4aq6 <- paste0(outputDir, "Power_correctionS4A_S6_aID", 1:600, ".txt")
names4aq7 <- paste0(outputDir, "Power_correctionS4A_S7_aID", 1:600, ".txt")
names4aq8 <- paste0(outputDir, "Power_correctionS4A_S8_aID", 1:600, ".txt")
names4aq9 <- paste0(outputDir, "Power_correctionS4A_S9_aID", 1:600, ".txt")
