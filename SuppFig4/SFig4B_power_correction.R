...
outName <- paste0("Power_correctionS4B_S", Snum, "_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- FALSE
testStatsName <- paste0("Power_correctionS4B_S", Snum, "_allZ")
betaName <- paste0("Power_correctionS4B_S", Snum, "_allBeta")
