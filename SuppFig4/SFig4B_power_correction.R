...
# setwd("/path/to/csmGmm_reproduce/SuppFig4/SFig4B_power_correction.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig4/SFig4B_power_correction.R")
...
outName <- paste0(outputDir, "/Power_correctionS4B_S", Snum, "_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- FALSE
testStatsName <- here::here(outputDir, "Power_correctionS4B_S", Snum, "_allZ")
betaName <- here::here(outputDir, "Power_correctionS4B_S", Snum, "_allBeta")
