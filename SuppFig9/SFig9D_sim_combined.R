...
# setwd("/path/to/csmGmm_reproduce/SuppFig9/SFig9D_sim_combined.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig9/SFig9D_sim_combined.R")
...
outName <- paste0(outputDir, "/sim_n1k_j100k_ind6d_changepi0_combined_aID", aID, ".txt")
...
testStatsName <- here::here(outputDir, "all6Z_changepi0")
betaName <- here::here(outputDir, "all6Beta_changepi0")
...
betaMin <- rep(0.34, nDims)
betaMax <- rep(0.44, nDims)
beta0 <- -1
...
sProp <- c(pi0, pi1, pi2, pi3, pi3, 0, 2*pi3)
