...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig5/output"
genotypeDir <- "/rsrch3/scratch/biostatistics/rsun3/empBayesGeneticData"
outName <- paste0("SFig5B_aID", aID, ".txt")

# real genotypes location and names
genotypeDir <- "/rsrch3/scratch/biostatistics/rsun3/empBayesGeneticData"
#genotypeNames <- paste0("cleanG_set", 1:260, "_dataset1.txt")
...
loadData <- FALSE
saveData <- TRUE
testStatsName <- "SFig5B_allZ"
betaName <- "SFig5B_allBeta"
#-------------------------------------------------------------------#
...
# record results here
powerRes <- data.frame(nCausal=rep(NA, nSims),  nSig2=NA, minEff1=pi1,
