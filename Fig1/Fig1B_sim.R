...
# setwd("/path/to/csmGmm_reproduce/Fig1/Fig1B_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("Fig1/Fig1B_sim.R")
...
outName <- paste0(outputDir, "/Fig1B_aID", aID, ".txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- FALSE
# these names are for if saveData <- TRUE
testStatsName <- here::here(outputDir, "Fig1B_allZ")
betaName <- here::here(outputDir, "Fig1B_allBeta")
