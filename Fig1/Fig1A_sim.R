...
# setwd("/path/to/Fig1/Fig1A_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("Fig1/Fig1A_sim.R")
...
testStatsName <- here::here(outputDir, "Fig1A_allZ")
betaName <- here::here(outputDir, "Fig1A_allBeta")
