...
# setwd("/path/to/csmGmm_reproduce/SuppFig28/SFig28A_sim_fitmed.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig28/SFig28A_sim_fitmed.R")
...
outName <- paste0(outputDir, "/SFig28A_aID", aID, "_fitmed.txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig28Afm_allZ")
betaName <- here::here(outputDir, "SFig28Afm_allBeta")
