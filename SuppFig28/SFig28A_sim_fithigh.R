...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig28/output"
outName <- paste0("SFig28A_aID", aID, "_fithigh.txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- FALSE
testStatsName <- "SFig28A_allZ"
betaName <- "SFig28A_allBeta"
#-------------------------------------------------------------------#
