...
outName <- paste0("SFig14A5k_aID", aID, ".txt")
...
betaMin <- c(0.25 + 0.01 * effSizeMult, 0.25 + 0.01 * effSizeMult, 0.25 + 0.01 * effSizeMult)
betaMax <- c(0.35 + 0.01 * effSizeMult, 0.35 + 0.01 * effSizeMult, 0.35 + 0.01 * effSizeMult)
beta0 <- -1
