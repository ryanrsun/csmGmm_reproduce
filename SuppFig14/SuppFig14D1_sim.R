...
# setwd("/path/to/csmGmm_reproduce/SuppFig14/SuppFig14D1_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig14/SuppFig14D1_sim.R")
...
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig14D1_allZ")
betaName <- here::here(outputDir, "SFig14D1_allBeta")
