...
betaOpts <- cbind(c(0.5 + 0.01 * effSizeMult, 0.6 + 0.01 * effSizeMult),
                  c(0.5 + 0.01 * effSizeMult, 0.6 + 0.01 * effSizeMult))
betaMin <- betaOpts[1, ]
betaMax <- betaOpts[2, ]
beta0 <- -1
