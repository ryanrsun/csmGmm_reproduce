...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig31/output"
outName <- paste0("SFig31A_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- FALSE
testStatsName <- "SFig31A_allZ"
betaName <- "SFig31A_allBeta"
#-------------------------------------------------------------------#
