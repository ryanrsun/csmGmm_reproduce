...
# setwd("/path/to/csmGmm_reproduce/SuppFig25/SFig25A_sim_fitreg.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig25/SFig25A_sim_fitreg.R")
...
outName <- paste0(outputDir, "/SFig25A_aID", aID, "_fitreg.txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig25Afr_allZ")
betaName <- here::here(outputDir, "SFig25Afr_allBeta")
