...
# setwd("/path/to/csmGmm_reproduce/SuppFig7/Supp_Fig7B_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig7/Supp_Fig7B_sim.R")
...
outName <- paste0(outputDir, "/SFig7B_aID", aID, ".txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- FALSE
# these names are for if saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig7B_allZ")
betaName <- here::here(outputDir, "SFig7B_allBeta")
