...
# setwd("/path/to/csmGmm_reproduce/SuppTab2/Fig3C_timing.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppTab2/Fig3C_timing.R")
...
outName <- paste0(outputDir, "/Fig3C_timing_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "Fig3C_timing_allZ")
betaName <- here::here(outputDir, "Fig3C_timing_allBeta")
