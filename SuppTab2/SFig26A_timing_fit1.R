...
# setwd("/path/to/csmGmm_reproduce/SuppTab2/SFig26A_timing_fit1.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppTab2/SFig26A_timing_fit1.R")
...
outName <- paste0(outputDir, "/SFig26A_aID", aID, "_fit1_timing.txt.txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig26A_timing1_allZ")
betaName <- here::here(outputDir, "SFig26A_timing1_allBeta")
