...
# setwd("/path/to/csmGmm_reproduce/SuppFig24/SFig24A_sim_fit1.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig24/SFig24A_sim_fit1.R")
...
outName <- paste0(outputDir, "/SFig24A_aID", aID, "_fit1.txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- TRUE
testStatsName <- here::here(outputDir, "SFig24Af1_allZ")
betaName <- here::here(outputDir, "SFig24Af1_allBeta")
