...
# setwd("/path/to/csmGmm_reproduce/SuppFig11/SFig11_sim_kernel.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.

here::i_am("SuppFig11/SFig11_sim_kernel.R")
# load libraries
library(mvtnorm)
library(data.table)
library(bindata)
...
outName <- paste0(outputDir, "/sim_n1k_j100k_ind7d_hard_changeeff_kernel_aID", aID, ".txt")
...
sProp <- c(0.95232, 0.04, rep(0.00128, nDims - 2), 0.00128)
