...
outName <- paste0(outputDir, "/Fig3D_aID", aID, ".txt")
...
testStatsName <- here::here(outputDir, "Fig3D_allZ")
betaName <- here::here(outputDir, "Fig3D_allBeta")
