...
names2aq1 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr1_raiseAlt_aID", 1:400, ".txt")
names2aq2 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr2_raiseAlt_aID", 1:400, ".txt")
names2aq3 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr3_raiseAlt_aID", 1:400, ".txt")
names2aq4 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr4_raiseAlt_aID", 1:400, ".txt")
names2aq5 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr5_raiseAlt_aID", 1:400, ".txt")
names2aq6 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr6_raiseAlt_aID", 1:400, ".txt")
names2aq7 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr7_raiseAlt_aID", 1:400, ".txt")
names2aq8 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr8_raiseAlt_aID", 1:400, ".txt")
names2aq9 <- paste0("sim_n1k_j100k_med2d_changeeff_fdr9_raiseAlt_aID", 1:400, ".txt")
names2aList <- list(names2aq1, names2aq2, names2aq3, names2aq4, names2aq5, names2aq6,
                    names2aq7, names2aq8, names2aq9)
names2bq1 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr1_raiseAlt_jan_aID", 1:400, ".txt")
names2bq2 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr2_raiseAlt_jan_aID", 1:400, ".txt")
names2bq3 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr3_raiseAlt_jan_aID", 1:400, ".txt")
names2bq4 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr4_raiseAlt_jan_aID", 1:400, ".txt")
names2bq5 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr5_raiseAlt_jan_aID", 1:400, ".txt")
names2bq6 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr6_raiseAlt_jan_aID", 1:400, ".txt")
names2bq7 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr7_raiseAlt_jan_aID", 1:400, ".txt")
names2bq8 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr8_raiseAlt_jan_aID", 1:400, ".txt")
names2bq9 <- paste0("sim_n1k_j100k_med2d_changepi0_fdr9_raiseAlt_jan_aID", 1:400, ".txt")
