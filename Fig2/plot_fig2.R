...
names2aq1 <- here::here(outputDir, paste0("Power_correction2A_S1_aID", 1:500, ".txt"))
names2aq2 <- here::here(outputDir, paste0("Power_correction2A_S2_aID", 1:500, ".txt"))
names2aq3 <- here::here(outputDir, paste0("Power_correction2A_S3_aID", 1:500, ".txt"))
names2aq4 <- here::here(outputDir, paste0("Power_correction2A_S4_aID", 1:500, ".txt"))
names2aq5 <- here::here(outputDir, paste0("Power_correction2A_S5_aID", 1:500, ".txt"))
names2aq6 <- here::here(outputDir, paste0("Power_correction2A_S6_aID", 1:500, ".txt"))
names2aq7 <- here::here(outputDir, paste0("Power_correction2A_S7_aID", 1:500, ".txt"))
names2aq8 <- here::here(outputDir, paste0("Power_correction2A_S8_aID", 1:500, ".txt"))
names2aq9 <- here::here(outputDir, paste0("Power_correction2A_S9_aID", 1:500, ".txt"))
names2aList <- list(names2aq1, names2aq2, names2aq3, names2aq4, names2aq5, names2aq6,
                    names2aq7, names2aq8, names2aq9)
names2bq1 <- here::here(outputDir, paste0("Power_correction2B_S1_aID", 1:500, ".txt"))
names2bq2 <- here::here(outputDir, paste0("Power_correction2B_S2_aID", 1:500, ".txt"))
names2bq3 <- here::here(outputDir, paste0("Power_correction2B_S3_aID", 1:500, ".txt"))
names2bq4 <- here::here(outputDir, paste0("Power_correction2B_S4_aID", 1:500, ".txt"))
names2bq5 <- here::here(outputDir, paste0("Power_correction2B_S5_aID", 1:500, ".txt"))
names2bq6 <- here::here(outputDir, paste0("Power_correction2B_S6_aID", 1:500, ".txt"))
names2bq7 <- here::here(outputDir, paste0("Power_correction2B_S7_aID", 1:500, ".txt"))
names2bq8 <- here::here(outputDir, paste0("Power_correction2B_S8_aID", 1:500, ".txt"))
names2bq9 <- here::here(outputDir, paste0("Power_correction2B_S9_aID", 1:500, ".txt"))
