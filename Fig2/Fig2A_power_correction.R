# For power correction of Figure 2A

# Using the here package to manage file paths. If an error is thrown, please
# set the working directory to the folder that holds this Rscript, e.g.
# setwd("/path/to/csmGmm_reproduce/Fig2/Fig2A_power_correction.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("Fig2/Fig2A_power_correction.R")
...
outName <- paste0(outputDir, "/Power_correction2A_S", Snum, "_aID", aID, ".txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- FALSE
# these names are for if saveData <- TRUE
testStatsName <- here::here(outputDir, paste0("Power_correction2A_S", Snum, "_allZ"))
betaName <- here::here(outputDir, paste0("Power_correction2A_S", Snum, "_allBeta"))
