...
outputDir <- "/rsrch3/home/biostatistics/rsun3/empBayes/reproduce/SuppFig1/output"
outName <- paste0("SuppFig1A_aID", aID, ".txt")

# option to save or load intermediate data to save time,
# set as FALSE for first run and then TRUE thereafter
loadData <- FALSE
saveData <- FALSE
testStatsName <- "SuppFig1A_allZ"
betaName <- "SuppFig1A_allBeta"
#-------------------------------------------------------------------#
