...
# setwd("/path/to/csmGmm_reproduce/SuppFig1/SuppFig1A_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig1/SuppFig1A_sim.R")
...
testStatsName <- here::here(outputDir, "SuppFig1A_allZ")
betaName <- here::here(outputDir, "SuppFig1A_allBeta")
