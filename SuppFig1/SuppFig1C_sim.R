...
# setwd("/path/to/csmGmm_reproduce/SuppFig1/SuppFig1C_sim.R") or set the path after the -cwd flag
# in the .lsf file, and then run again.
here::i_am("SuppFig1/SuppFig1C_sim.R")
...
outName <- paste0(outputDir, "/SuppFig1C_aID", aID, ".txt")

# option to save or load intermediate data to save time
loadData <- FALSE
saveData <- FALSE
# these names are for if saveData <- TRUE
testStatsName <- here::here(outputDir, "SuppFig1C_allZ")
betaName <- here::here(outputDir, "SuppFig1C_allBeta")
